...
describe('KAI module test', () => {
    ...
    it('should get block header by number successfully', async () => {
        const blockHeader = await kardiaClient.KAI.getBlockHeaderByBlockNumber(BLOCK_NUMBER)
    ...
    it('should get basic block by number successfully', async () => {
        const basicBlock = await kardiaClient.KAI.getBasicBlockByNumber(BLOCK_NUMBER)
