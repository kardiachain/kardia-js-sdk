...
describe('Transaction module test', () => {
  ...
  it('should get transaction detail successfully', async () => {
    const txDetail = await kardiaClient.transaction.getTransaction(
      TRANSACTION_HASH
    );
  ...
  it('should get transaction receipt successfully', async () => {
    const receipt = await kardiaClient.transaction.getTransactionReceipt(
      TRANSACTION_HASH
    );
  ...
  it('should send transaction successfully', async () => {
    ...
    const result = await kardiaClient.transaction.sendTransaction(
      txData,
      ACCOUNT1.privateKey
    );
